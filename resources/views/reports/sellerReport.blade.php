...
@section('content')
    <div class="col-md-12" id="page-top">
     ...
     <div class="col-auto">
                        ...
                        <span class="m-form__help">Vendedor</span>
                ...
                {{-- <p >Total: $<span id="total">0.00</span></p> --}}
                     ...
                     <!-- <div style="float: right;margin-right: 60px;margin-top:20px;">
                        {{-- <p style="font-weight:600;">Venta total: $</p> --}}
                         <b><p>Venta total: $<span id="total">0.00</span></p></b>
                    </div> -->
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#mtable4').DataTable( {
                ...
                buttons: [
                        ...
                        {
                            extend: 'excel',
                            messageTop: 'Reporte por vendedor '+ $('#start').val() + ' - '+  $('#end').val()
                        },
                        {
                            extend: 'pdf',
                            messageTop: 'Reporte por vendedor '+ $('#start').val() + ' - '+  $('#end').val()
                        },
                        {
                            ...
                            messageTop: function () {
                                ...
                                if ( printCounter === 1 ) {
                                    return 'Reporte por vendedor '+ $('#start').val() + ' - '+  $('#end').val();
                                }
                                else {
                                    return 'Reporte por vendedor '+ $('#start').val() + ' - '+  $('#end').val();
                                }
        ...
        function filtro() {
            ...
            if ((start==null) || (end==null)){
                ...
                $.ajax({
                    url: "/filtroSellerCategorias",
                    headers:{'X-CSRF-TOKEN': '{{ csrf_token() }}'},
                    type: "POST",
                    data:{categories_id:categories_id,seller_id:seller_id,start:newStart,end:newEnd},
