                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="mtable2">
                    ...
                    @foreach($products as $product)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                @if(isset($product->getUnitsPrice[0]->price))
                                    ${{number_format($product->getUnitsPrice[0]->price,2,'.','')}}
                                @else
                            ...
                            <td>
                                ...
                                <a href="/productSp/{{$product->id}}/edit" title="Editar" class="btn btn-icon-only btn-warning  m-btn m-btn--pill "
