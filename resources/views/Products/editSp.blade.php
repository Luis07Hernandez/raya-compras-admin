...
@section('content')
    ...
    <div class="col-md-12">
        <div class="m-portlet" style="align: center;">
            ...
            {!! Form::model($product,['route' => ['productSp.update',$product->id], 'method' => 'PUT','files' => true,'enctype'=>'multipart/form-data', 'class' => 'm-form m-form--fit m-form--label-align-right']) !!}
